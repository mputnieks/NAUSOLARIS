...
// This sketch was part of the development process of INFiniti one - _______
// Written by Mikelis Putnieks on ______

void read_voltage();
void read_temperature();
void write_data();

#define ONE_WIRE_BUS 2         // Temperature data wire is connecred to the Arduino digital pin 2
